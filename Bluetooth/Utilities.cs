...
namespace Bluetooth.GATT
{
    public static class Utilities
    {
        ...
        {
            var characteristic = characteristics.Find(a => a.Name == characteristicName)?.characteristic;
        ...
        public static async Task<bool> WriteCharacteristicValueAsync(List<BluetoothAttribute> characteristics, string characteristicName, IBuffer ibuffer)
        {
            var characteristic = characteristics.Find(a => a.Name == characteristicName)?.characteristic;
            if (characteristic == null)
                return false;

            var readResult = await characteristic.WriteValueAsync(ibuffer);
            return readResult == GattCommunicationStatus.Success;
        }
        ...
        /// according the Bluetooth Heart Rate Profile.
